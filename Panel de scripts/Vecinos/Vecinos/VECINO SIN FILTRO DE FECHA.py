...
def encontrar_archivo_entrada():
    ...
    archivos = [a for a in archivos if "Informe_Vecinos" not in a and not a.startswith("~$")]
    ...
    archivos_csv = [a for a in archivos_csv if "Informe_Vecinos" not in a and not a.startswith("~$")]
